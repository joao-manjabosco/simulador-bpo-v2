 ...
 *
 * @license MIT
 */const PS="6";try{window.__reactRouterVersion=PS}catch{}const kS="startTransition",ig=RT[kS];function xS(t){let{basename:e,children:n,future:r,window:i}=t,s=B.useRef();s.current==null&&(s.current=F1({window:i,v5Compat:!0}));let o=s.current,[l,u]=B.useState({action:o.action,location:o.location}),{v7_startTransition:h}=r||{},f=B.useCallback(p=>{h&&ig?ig(()=>u(p)):u(p)},[u,h]);return B.useLayoutEffect(()=>o.listen(f),[o,f]),B.useEffect(()=>SS(r),[r]),B.createElement(RS,{basename:e,children:n,location:l.location,navigationType:l.action,navigator:o,future:r})}var sg;(function(t){t.UseScrollRestoration="useScrollRestoration",t.UseSubmit="useSubmit",t.UseSubmitFetcher="useSubmitFetcher",t.UseFetcher="useFetcher",t.useViewTransitionState="useViewTransitionState"})(sg||(sg={}));var og;(function(t){t.UseFetcher="useFetcher",t.UseFetchers="useFetchers",t.UseScrollRestoration="useScrollRestoration"})(og||(og={}));function NS(){const t=()=>{window.location.href="https://buy.stripe.com/bJe28qh0K6Rp0DLb9l9R600"};return C.jsx("div",{className:"min-h-screen bg-gray-900 flex items-center justify-center p-4",children:C.jsx("div",{className:"bg-white rounded-2xl shadow-2xl p-8 w-full max-w-2xl text-center",children:C.jsxs("div",{className:"mb-8",children:[C.jsx("h1",{className:"text-4xl font-bold text-gray-800 mb-4",children:"Simulador Profissional BPO"}),C.jsx("h2",{className:"text-xl text-gray-600 mb-6",children:"Acesso Vitalício por apenas R$ 497"}),C.jsxs("div",{className:"bg-blue-50 p-6 rounded-lg mb-8",children:[C.jsx("h3",{className:"text-lg font-semibold text-blue-800 mb-4",children:"O que você vai receber:"}),C.jsxs("ul",{className:"text-left text-blue-700 space-y-2",children:[C.jsx("li",{children:"✅ Simulador completo de precificação BPO"}),C.jsx("li",{children:"✅ Cálculo automático baseado em critérios profissionais"}),C.jsx("li",{children:"✅ Score gamificado para classificação de clientes"}),C.jsx("li",{children:"✅ Customização de equipe com impacto no preço"}),C.jsx("li",{children:"✅ Acesso vitalício - pague uma vez, use para sempre"}),C.jsx("li",{children:"✅ Atualizações futuras incluídas"})]})]}),C.jsxs("div",{className:"mb-8",children:[C.jsx("div",{className:"text-3xl font-bold text-green-600 mb-2",children:"R$ 497"}),C.jsx("div",{className:"text-gray-500 line-through text-lg",children:"De R$ 997"}),C.jsx("div",{className:"text-sm text-red-600 font-medium",children:"Oferta por tempo limitado!"})]}),C.jsx("button",{onClick:t,className:"bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-lg text-xl transition-colors duration-200 shadow-lg hover:shadow-xl",children:"Comprar Agora - Acesso Vitalício"}),C.jsxs("div",{className:"mt-6 text-sm text-gray-500",children:[C.jsx("p",{children:"🔒 Pagamento 100% seguro via Stripe"}),C.jsx("p",{children:"💳 Cartão de crédito, débito ou PIX"}),C.jsx("p",{children:"📧 Acesso enviado automaticamente por e-mail"})]})]})})})}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class GD{constructor(e){this.app=e}_delete(){return delete Ks[this.app.options.appId],Promise.resolve()}}let Ks={},Ey=[];const Ty={};let Dc="dataLayer",QD="gtag",Iy,NE,Sy=!1;function YD(){const t=[];if(i0()&&t.push("This is a browser extension environment."),GS()||t.push("Cookies are not available."),t.length>0){const e=t.map((r,i)=>`(${i+1}) ${r}`).join(" "),n=vt.create("invalid-analytics-context",{errorInfo:e});ft.warn(n.message)}}function XD(t,e,n){YD();const r=t.options.appId;if(!r)throw vt.create("no-app-id");if(!t.options.apiKey)if(t.options.measurementId)ft.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${t.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw vt.create("no-api-key");if(Ks[r]!=null)throw vt.create("already-exists",{id:r});if(!Sy){xD(Dc);const{wrappedGtag:s,gtagCore:o}=VD(Ks,Ey,Ty,Dc,QD);NE=s,Iy=o,Sy=!0}return Ks[r]=KD(t,Ey,Ty,e,Iy,Dc,n),new GD(t)}function JD(t=Qd()){t=st(t);const e=Kr(t,Ul);return e.isInitialized()?e.getImmediate():ZD(t)}function ZD(t,e={}){const n=Kr(t,Ul);if(n.isInitialized()){const i=n.getImmediate();if(po(e,n.getOptions()))return i;throw vt.create("already-initialized")}return n.initialize({options:e})}function e2(t,e,n,r){t=st(t),qD(NE,Ks[t.app.options.appId],e,n,r).catch(i=>ft.error(i))}const Ay="@firebase/analytics",Ry="0.10.8";function t2(){tn(new Bt(Ul,(e,{options:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("installations-internal").getImmediate();return XD(r,i,n)},"PUBLIC")),tn(new Bt("analytics-internal",t,"PRIVATE")),Pt(Ay,Ry),Pt(Ay,Ry,"esm2017");function t(e){try{const n=e.getProvider(Ul).getImmediate();return{logEvent:(r,i,s)=>e2(n,r,i,s)}}catch(n){throw vt.create("interop-component-reg-failed",{reason:n})}}}t2();const n2={apiKey:"AIzaSyBeJO3zIDJpBxHOmJPLHOQJacRsQ-RPBKs",authDomain:"simulador-bpo.firebaseapp.com",projectId:"simulador-bpo",storageBucket:"simulador-bpo.firebasestorage.app",messagingSenderId:"597279325224",appId:"1:597279325224:web:9a5f98f21ecae8778cc91d",measurementId:"G-JL9BLPTVL1"},zf=c0(n2);JD(zf);const xa=IP(zf),Cy=mN(zf);function Eu(){const[t,e]=B.useState(null),[n,r]=B.useState(null),[i,s]=B.useState(!0);return B.useEffect(()=>hC(xa,async f=>{if(e(f),f){const p=await xN(yy(Cy,"users",f.uid));p.exists()&&r(p.data())}else r(null);s(!1)}),[]),{user:t,userData:n,loading:i,login:async(h,f)=>{try{return(await lC(xa,h,f)).user}catch(p){throw p}},register:async(h,f)=>{try{const p=await aC(xa,h,f),g={uid:p.user.uid,email:p.user.email,hasPaid:!0,createdAt:new Date};return await DN(yy(Cy,"users",p.user.uid),g),r(g),p.user}catch(p){throw p}},logout:async()=>{try{await dC(xa)}catch(h){throw h}}}}function r2(){const[t,e]=B.useState(""),[n,r]=B.useState(""),[i,s]=B.useState(!1),[o,l]=B.useState(""),u=ru(),{login:h}=Eu(),f=async p=>{p.preventDefault(),l(""),s(!0);try{await h(t,n),u("/simulador")}catch(g){switch(console.error("Erro no login:",g),g.code){case"auth/user-not-found":l("Usuário não encontrado");break;case"auth/wrong-password":l("Senha incorreta");break;case"auth/invalid-email":l("E-mail inválido");break;case"auth/too-many-requests":l("Muitas tentativas. Tente novamente mais tarde");break;default:l("Erro ao fazer login. Tente novamente.")}}finally{s(!1)}};return C.jsx("div",{className:"min-h-screen gradient-bg flex items-center justify-center p-4",children:C.jsxs("div",{className:"glass-effect rounded-3xl shadow-2xl p-10 w-full max-w-md animate-fade-in",children:[C.jsxs("div",{className:"text-center mb-10",children:[C.jsx("div",{className:"w-20 h-20 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-6",children:C.jsx("span",{className:"text-3xl",children:"🔐"})}),C.jsx("h1",{className:"text-3xl font-bold text-gradient mb-3",children:"Entrar na Sua Conta"}),C.jsx("p",{className:"text-gray-600 font-medium",children:"Acesse seu simulador profissional BPO"})]}),C.jsxs("form",{onSubmit:f,className:"space-y-6",children:[C.jsxs("div",{className:"animate-slide-up",children:[C.jsx("label",{className:"block text-lg font-semibold text-gray-700 mb-3",children:"📧 E-mail"}),C.jsx("input",{type:"email",value:t,onChange:p=>e(p.target.value),className:"w-full p-4 input-modern rounded-xl text-gray-800 font-medium",placeholder:"seu@email.com",required:!0})]}),C.jsxs("div",{className:"animate-slide-up",children:[C.jsx("label",{className:"block text-lg font-semibold text-gray-700 mb-3",children:"🔒 Senha"}),C.jsx("input",{type:"password",value:n,onChange:p=>r(p.target.value),className:"w-full p-4 input-modern rounded-xl text-gray-800 font-medium",placeholder:"Sua senha",required:!0})]}),o&&C.jsx("div",{className:"bg-red-50 border-l-4 border-red-400 text-red-700 px-4 py-3 rounded-lg animate-fade-in",children:C.jsxs("div",{className:"flex items-center",children:[C.jsx("span",{className:"mr-2",children:"⚠️"}),o]})}),C.jsx("button",{type:"submit",disabled:i,className:"w-full btn-modern py-4 px-6 rounded-xl text-lg font-bold transition-all duration-300 animate-slide-up",children:i?C.jsxs("div",{className:"flex items-center justify-center",children:[C.jsx("div",{className:"animate-spin w-5 h-5 border-2 border-white border-t-transparent rounded-full mr-2"}),"Entrando..."]}):"🚀 Entrar"})]}),C.jsx("div",{className:"mt-8 text-center animate-fade-in",children:C.jsxs("p",{className:"text-gray-600 font-medium",children:["Ainda não tem uma conta?"," ",C.jsx("button",{onClick:()=>u("/register"),className:"text-blue-600 hover:text-blue-700 font-bold transition-colors",children:"Criar conta"})]})}),C.jsx("div",{className:"mt-6 text-center animate-fade-in",children:C.jsx("button",{onClick:()=>u("/"),className:"text-gray-500 hover:text-gray-700 font-medium transition-colors",children:"← Voltar para página inicial"})})]})})}function i2(){const[t,e]=B.useState(""),[n,r]=B.useState(""),[i,s]=B.useState(""),[o,l]=B.useState(!1),[u,h]=B.useState(""),f=ru(),{register:p}=Eu(),g=async S=>{if(S.preventDefault(),h(""),n!==i){h("As senhas não coincidem");return}if(n.length<6){h("A senha deve ter pelo menos 6 caracteres");return}l(!0);try{await p(t,n),f("/simulador")}catch(k){switch(console.error("Erro no registro:",k),k.code){case"auth/email-already-in-use":h("Este e-mail já está em uso");break;case"auth/invalid-email":h("E-mail inválido");break;case"auth/weak-password":h("Senha muito fraca");break;default:h("Erro ao criar conta. Tente novamente.")}}finally{l(!1)}};return C.jsx("div",{className:"min-h-screen gradient-bg flex items-center justify-center p-4",children:C.jsxs("div",{className:"glass-effect rounded-3xl shadow-2xl p-10 w-full max-w-md animate-fade-in",children:[C.jsxs("div",{className:"text-center mb-10",children:[C.jsx("div",{className:"w-20 h-20 bg-gradient-to-r from-green-500 to-blue-600 rounded-full flex items-center justify-center mx-auto mb-6",children:C.jsx("span",{className:"text-3xl",children:"🚀"})}),C.jsx("h1",{className:"text-3xl font-bold text-gradient mb-3",children:"Criar Sua Conta"}),C.jsx("p",{className:"text-gray-600 font-medium",children:"Você já pagou! Agora crie sua conta para acessar o simulador."})]}),C.jsxs("form",{onSubmit:g,className:"space-y-6",children:[C.jsxs("div",{className:"animate-slide-up",children:[C.jsx("label",{className:"block text-lg font-semibold text-gray-700 mb-3",children:"📧 E-mail"}),C.jsx("input",{type:"email",value:t,onChange:S=>e(S.target.value),className:"w-full p-4 input-modern rounded-xl text-gray-800 font-medium",placeholder:"seu@email.com",required:!0})]}),C.jsxs("div",{className:"animate-slide-up",children:[C.jsx("label",{className:"block text-lg font-semibold text-gray-700 mb-3",children:"🔒 Senha"}),C.jsx("input",{type:"password",value:n,onChange:S=>r(S.target.value),className:"w-full p-4 input-modern rounded-xl text-gray-800 font-medium",placeholder:"Mínimo 6 caracteres",required:!0})]}),C.jsxs("div",{className:"animate-slide-up",children:[C.jsx("label",{className:"block text-lg font-semibold text-gray-700 mb-3",children:"🔐 Confirmar Senha"}),C.jsx("input",{type:"password",value:i,onChange:S=>s(S.target.value),className:"w-full p-4 input-modern rounded-xl text-gray-800 font-medium",placeholder:"Digite a senha novamente",required:!0})]}),u&&C.jsx("div",{className:"bg-red-50 border-l-4 border-red-400 text-red-700 px-4 py-3 rounded-lg animate-fade-in",children:C.jsxs("div",{className:"flex items-center",children:[C.jsx("span",{className:"mr-2",children:"⚠️"}),u]})}),C.jsx("button",{type:"submit",disabled:o,className:"w-full btn-modern py-4 px-6 rounded-xl text-lg font-bold transition-all duration-300 animate-slide-up",children:o?C.jsxs("div",{className:"flex items-center justify-center",children:[C.jsx("div",{className:"animate-spin w-5 h-5 border-2 border-white border-t-transparent rounded-full mr-2"}),"Criando conta..."]}):"🚀 Criar Conta e Acessar Simulador"})]}),C.jsx("div",{className:"mt-8 text-center animate-fade-in",children:C.jsxs("p",{className:"text-gray-600 font-medium",children:["Já tem uma conta?"," ",C.jsx("button",{onClick:()=>f("/login"),className:"text-blue-600 hover:text-blue-700 font-bold transition-colors",children:"Fazer login"})]})}),C.jsx("div",{className:"mt-6 text-center animate-fade-in",children:C.jsx("button",{onClick:()=>f("/"),className:"text-gray-500 hover:text-gray-700 font-medium transition-colors",children:"← Voltar para página inicial"})})]})})}function s2(){const t=ru();return B.useEffect(()=>{const e=setTimeout(()=>{t("/register")},3e3);return()=>clearTimeout(e)},[t]),C.jsx("div",{className:"min-h-screen bg-gray-900 flex items-center justify-center p-4",children:C.jsx("div",{className:"bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md text-center",children:C.jsxs("div",{className:"mb-8",children:[C.jsx("div",{className:"w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4",children:C.jsx("svg",{className:"w-8 h-8 text-green-600",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:C.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M5 13l4 4L19 7"})})}),C.jsx("h1",{className:"text-2xl font-bold text-gray-800 mb-4",children:"Pagamento Confirmado!"}),C.jsx("p",{className:"text-gray-600 mb-6",children:"Seu pagamento foi processado com sucesso. Você será redirecionado para criar sua conta em alguns segundos."}),C.jsxs("div",{className:"bg-green-50 p-4 rounded-lg mb-6",children:[C.jsx("h3",{className:"font-semibold text-green-800 mb-2",children:"Próximos passos:"}),C.jsxs("ol",{className:"text-left text-green-700 text-sm space-y-1",children:[C.jsx("li",{children:"1. Crie sua conta de acesso"}),C.jsx("li",{children:"2. Confirme seu e-mail"}),C.jsx("li",{children:"3. Acesse o simulador profissional"})]})]}),C.jsx("button",{onClick:()=>t("/register"),className:"bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg transition-colors duration-200",children:"Criar Minha Conta Agora"})]})})})}const o2=["BPO Financeiro - Tesouraria","BPO Gestão Financeira","BPO Controladoria","Consultoria Financeira"],ni={tipoServico:"🏢",funcionarios:"👥",contas:"🏦",erp:"💻",maturidade:"📊",equipe:"👨‍💼"};function a2(t,e,n,r,i,s=""){let o=100;switch(t){case"BPO Financeiro - Tesouraria":case"BPO Gestão Financeira":e>5&&(o-=15),n>1&&(o-=10),r==="Não"&&(o-=20),i==="Média"&&(o-=10),i==="Baixa"&&(o-=25);break;case"BPO Controladoria":case"CFO as a Service":r==="Não"&&(o-=15),i==="Média"&&(o-=10),i==="Baixa"&&(o-=25);break;case"Consultoria Financeira":r==="Não"&&(o-=10),i==="Baixa"&&(o-=15);break}if(s.trim()){const u=s.toLowerCase();let h=0;const f=["senior","sênior","especialista","gerente","coordenador","analista senior","consultor","supervisor","líder","pleno"],p=["junior","júnior","estagiário","trainee","assistente","auxiliar","operacional","básico"];let g=0,S=0;f.forEach(k=>{u.includes(k)&&g++}),p.forEach(k=>{u.includes(k)&&S++}),g>S?h=g*5:S>g&&(h=-(S*5)),o+=h}o=Math.max(0,Math.min(100,o));let l="Cliente Ideal";return o<40?l="Cliente Difícil":o<70&&(l="Cliente Médio"),{score:o,classificacao:l}}function l2(t){let e=0;return t>=90?e=2500:t>=70?e=2e3:t>=40?e=1500:e=1e3,e*=t/100*.5+.75,Math.round(e)}function u2({score:t,price:e,classificacao:n}){const r=2*Math.PI*50,i=r,s=r-t/100*r,o=()=>t>=70?"#10B981":t>=40?"#F59E0B":"#EF4444",l=()=>t>=70?"from-green-400 to-green-600":t>=40?"from-yellow-400 to-orange-500":"from-red-400 to-red-600";return C.jsxs("div",{className:"result-card animate-fade-in",children:[C.jsxs("div",{className:"relative mb-6",children:[C.jsxs("svg",{className:"w-32 h-32 mx-auto transform -rotate-90 score-circle",viewBox:"0 0 120 120",children:[C.jsx("circle",{cx:"60",cy:"60",r:"50",stroke:"#E5E7EB",strokeWidth:"8",fill:"none"}),C.jsx("circle",{cx:"60",cy:"60",r:"50",stroke:o(),strokeWidth:"8",fill:"none",strokeDasharray:i,strokeDashoffset:s,strokeLinecap:"round",className:"transition-all duration-1000"})]}),C.jsxs("div",{className:"absolute inset-0 flex flex-col items-center justify-center",children:[C.jsx("span",{className:"text-4xl font-bold text-gray-800",children:t}),C.jsx("span",{className:"text-sm font-medium text-gray-600",children:n})]})]}),C.jsxs("div",{className:"text-center",children:[C.jsx("p",{className:"text-lg font-semibold text-gray-700 mb-2",children:"💰 Preço Estimado"}),C.jsxs("p",{className:`text-4xl font-bold bg-gradient-to-r ${l()} bg-clip-text text-transparent`,children:["R$ ",e.toLocaleString("pt-BR")]}),C.jsx("p",{className:"text-sm text-gray-500 mt-2",children:"Valor mensal estimado"})]})]})}function ri({icon:t,label:e,children:n}){return C.jsxs("div",{className:"field-container animate-slide-up",children:[C.jsxs("div",{className:"flex items-center mb-3",children:[C.jsx("div",{className:"icon-container",children:t}),C.jsx("label",{className:"text-lg font-semibold text-gray-800",children:e})]}),n]})}function c2(){const[t,e]=B.useState("BPO Controladoria"),[n,r]=B.useState(5),[i,s]=B.useState(1),[o,l]=B.useState("Não"),[u,h]=B.useState("Alta"),[f,p]=B.useState(""),{user:g,logout:S}=Eu(),{score:k,classificacao:N}=a2(t,n,i,o,u,f),D=l2(k),I=async()=>{try{await S()}catch(v){console.error("Erro ao fazer logout:",v)}};return C.jsxs("div",{className:"min-h-screen gradient-bg p-4",children:[C.jsx("div",{className:"max-w-6xl mx-auto mb-8 animate-fade-in",children:C.jsxs("div",{className:"header-card rounded-2xl shadow-xl p-6 flex justify-between items-center",children:[C.jsxs("div",{children:[C.jsx("h1",{className:"text-2xl font-bold text-gradient",children:"🚀 Simulador Profissional BPO"}),C.jsxs("p",{className:"text-gray-600 font-medium",children:["Bem-vindo, ",g==null?void 0:g.email]})]}),C.jsx("button",{onClick:I,className:"bg-red-500 hover:bg-red-600 text-black px-6 py-3 rounded-xl font-semibold transition-all duration-300 hover:transform hover:scale-105",children:"↗️ Sair"})]})}),C.jsx("div",{className:"max-w-6xl mx-auto",children:C.jsxs("div",{className:"main-container rounded-3xl shadow-2xl p-8",children:[C.jsxs("div",{className:"text-center mb-12 animate-fade-in",children:[C.jsx("h2",{className:"text-4xl font-bold text-white mb-4",children:"⚡ Simulador de Precificação"}),C.jsx("h3",{className:"text-2xl font-semibold text-white opacity-90",children:"de Serviços BPO"}),C.jsx("div",{className:"w-24 h-1 bg-gradient-to-r from-blue-400 to-purple-500 mx-auto mt-4 rounded-full"})]}),C.jsxs("div",{className:"grid lg:grid-cols-3 gap-8",children:[C.jsx("div",{className:"lg:col-span-2 space-y-6",children:C.jsxs("div",{className:"grid md:grid-cols-2 gap-8",children:[C.jsx(ri,{icon:ni.tipoServico,label:"Tipo de Serviço",children:C.jsx("select",{className:"w-full p-4 input-modern rounded-xl text-gray-800 font-medium",value:t,onChange:v=>e(v.target.value),children:o2.map(v=>C.jsx("option",{value:v,children:v},v))})}),C.jsx(ri,{icon:ni.funcionarios,label:"Número de Funcionários",children:C.jsxs("select",{className:"w-full p-4 input-modern rounded-xl text-gray-800 font-medium",value:n,onChange:v=>r(Number(v.target.value)),children:[C.jsx("option",{value:5,children:"05"}),C.jsx("option",{value:10,children:"10"}),C.jsx("option",{value:20,children:"20"}),C.jsx("option",{value:50,children:"50"}),C.jsx("option",{value:100,children:"100+"})]})}),C.jsx(ri,{icon:ni.contas,label:"Contas Bancárias",children:C.jsxs("select",{className:"w-full p-4 input-modern rounded-xl text-gray-800 font-medium",value:i,onChange:v=>s(Number(v.target.value)),children:[C.jsx("option",{value:1,children:"1 Conta"}),C.jsx("option",{value:2,children:"2 Contas"}),C.jsx("option",{value:3,children:"3 Contas"}),C.jsx("option",{value:5,children:"5+ Contas"})]})}),C.jsx(ri,{icon:ni.erp,label:"ERP em Nuvem",children:C.jsxs("select",{className:"w-full p-4 input-modern rounded-xl text-gray-800 font-medium",value:o,onChange:v=>l(v.target.value),children:[C.jsx("option",{value:"Não",children:"Não"}),C.jsx("option",{value:"Sim",children:"Sim"})]})}),C.jsx(ri,{icon:ni.maturidade,label:"Maturidade dos Processos",children:C.jsxs("select",{className:"w-full p-4 input-modern rounded-xl text-gray-800 font-medium",value:u,onChange:v=>h(v.target.value),children:[C.jsx("option",{value:"Alta",children:"Alta"}),C.jsx("option",{value:"Média",children:"Média"}),C.jsx("option",{value:"Baixa",children:"Baixa"})]})}),C.jsxs(ri,{icon:ni.equipe,label:"Equipe Sugerida",children:[C.jsx("textarea",{className:"w-full p-4 input-modern rounded-xl text-gray-800 font-medium resize-none",rows:4,value:f,onChange:v=>p(v.target.value),placeholder:"Ex: 1 analista senior, 2 assistentes júnior..."}),f.trim()&&C.jsx("div",{className:"mt-3 p-3 bg-blue-50 rounded-lg border-l-4 border-blue-400",children:C.jsx("p",{className:"text-sm text-blue-700 font-medium",children:"💡 O preço está sendo ajustado com base na equipe informada"})})]})]})}),C.jsx("div",{className:"lg:col-span-1 flex items-center justify-center",children:C.jsx(u2,{score:k,price:D,classificacao:N})})]})]})})]})}function h2({children:t}){const{user:e,userData:n,loading:r}=Eu();return r?C.jsx("div",{className:"min-h-screen bg-gray-900 flex items-center justify-center",children:C.jsxs("div",{className:"bg-white rounded-lg p-8 text-center",children:[C.jsx("div",{className:"animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600 mx-auto mb-4"}),C.jsx("p",{className:"text-gray-600",children:"Verificando acesso..."})]})}):e?n!=null&&n.hasPaid?C.jsx(C.Fragment,{children:t}):C.jsx("div",{className:"min-h-screen bg-gray-900 flex items-center justify-center p-4",children:C.jsxs("div",{className:"bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md text-center",children:[C.jsx("div",{className:"w-16 h-16 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-4",children:C.jsx("svg",{className:"w-8 h-8 text-red-600",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:C.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z"})})}),C.jsx("h1",{className:"text-2xl font-bold text-gray-800 mb-4",children:"Acesso Restrito"}),C.jsx("p",{className:"text-gray-600 mb-6",children:"Você precisa adquirir o simulador para ter acesso a esta área."}),C.jsx("button",{onClick:()=>window.location.href="/",className:"bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg transition-colors duration-200",children:"Adquirir Simulador"})]})}):C.jsx(AS,{to:"/login",replace:!0})}function d2(){return C.jsx(xS,{children:C.jsxs(CS,{children:[C.jsx(ii,{path:"/",element:C.jsx(NS,{})}),C.jsx(ii,{path:"/login",element:C.jsx(r2,{})}),C.jsx(ii,{path:"/register",element:C.jsx(i2,{})}),C.jsx(ii,{path:"/sucesso",element:C.jsx(s2,{})}),C.jsx(ii,{path:"/simulador",element:C.jsx(h2,{children:C.jsx(c2,{})})})]})})}Oc.createRoot(document.getElementById("root")).render(C.jsx(d2,{}));
